...
export const CLIENT_DOC_TYPES: Record<string, string[]> = {
  "Яндекс":        ["Договор", "Приложение", "Счёт", "УПД", "Акт", "СФ"],
  "Сбер":          ["Договор", "Приложение", "Счёт", "Акт", "СФ"],
  "Авито":         ["Договор", "Приложение", "Счёт", "УПД", "Акт", "СФ"],
  "Альфа-Банк ТГ": ["Договор", "Приложение", "Счёт", "УПД", "Акт", "СФ"],
};
