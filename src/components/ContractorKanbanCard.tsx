...
import { ContractorKanbanDocument } from "@/mocks/contractorsKanbanMockData";
import { DOC_TYPE_BADGE_STYLES } from "@/components/KanbanCard";

interface ContractorKanbanCardProps {
  document: ContractorKanbanDocument;
}

export function ContractorKanbanCard({ document }: ContractorKanbanCardProps) {
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <span style={{ fontSize: 11.5, color: "#6B7280" }}>
          Клиент: <span style={{ fontWeight: 600, color: "#111827" }}>{clientName}</span>
        </span>
...
export default ContractorKanbanCard;
